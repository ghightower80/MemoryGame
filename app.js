...
document.querySelector("#moves-count").style.visibility = "hidden";
...
function noMatch() {
    document.querySelector('#moves-count').innerText = score;
    document.querySelector('#moves-count').style.visibility = "visible";
